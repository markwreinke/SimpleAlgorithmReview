...
class Matrix():
    ...
    # A function to update matrix elements
    def editMatrix(row, column, newElement):
        matrixElements[row][column] = newElement

    # A function to return an element
    def getElement(row, column):
        return matrixElements[row][columne]
